/* 
 ******************************************************************************
 * File: GlycoParaPanel.java * * * Created on 2011-9-26
 *
...
public class NGlycoParaPanel extends JPanel {
	...
	public NGlycoParaPanel() {
		initComponents();
	}
	
	public NGlycoParaPanel(boolean noPepMatch) {
		initComponents();
		if(noPepMatch){
	...
	public NGlycoParaPanel(boolean label, boolean oGlyco) {
		this.label = label;
		this.oGlyco = oGlyco;
		initComponents();
	}
	...
	private void initComponents() {
		...
		add(getJLabelDeLabel(), new Constraints(new Leading(36, 10, 10), new Leading(5, 10, 10)));
		add(getJRadioButton0(), new Constraints(new Leading(215, 10, 10), new Leading(5, 10, 10)));
		add(getJRadioButton1(), new Constraints(new Leading(290, 10, 10), new Leading(5, 10, 10)));
