/* 
 ******************************************************************************
 * File: IntArrayList.java * * * Created on 11-17-2008
 *
...
/**
 * This is an collection for int values (Not the integer instance).
 * 
 * @author Xinning
 * @version 0.1, 11-17-2008, 09:35:35
 */
public class IntArrayList {
    ...
    /**
     * This method will first cast the integer values into short and return the short array.
     * Therefore, please take care of this methods while cast the int values to short value.
     * 
     * @return
     */
    public short[] toShortArray(){
    	...
    	for(int i=0;i<size;i++){
    		result[i] = (short)this.elementData[i];
    	}
