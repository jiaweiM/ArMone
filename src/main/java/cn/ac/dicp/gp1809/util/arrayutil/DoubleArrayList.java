/*
 * *****************************************************************************
 * File: DoubleArrayList.java * * * Created on 10-28-2008
 * 
...
/**
 * An arraylist for primitive data(modified from arraylist)
 * 
 * @author Xinning
 * @version 0.1, 10-28-2008, 22:01:19
 */
public class DoubleArrayList {
    ...
    public float[] toFloatArray(){
    	...
    	for(int i=0;i<size;i++){
    		result[i] = (float)this.elementData[i];
    	}
    ...
    public int[] toIntArray(){
    	...
    	for(int i=0;i<size;i++){
    		result[i] = (int)this.elementData[i];
    	}
